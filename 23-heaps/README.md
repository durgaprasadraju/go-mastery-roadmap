...
> **Category:** data-structures | **Level:** intermediate | **Module:** `23-heaps`

## Overview

This module covers **Heaps** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Heaps
...
Heaps is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
