...
|------|----------|-------------|
| `exercise1.go` | Exercise 1 | Core Heaps implementation |
...
```bash
go test ./23-heaps/exercises/solutions/...
```

## Run Benchmarks

```bash
go test -bench=. ./23-heaps/exercises/solutions/...
```
