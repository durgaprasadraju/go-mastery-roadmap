...
> **Category:** testing | **Level:** beginner | **Module:** `104-unit-testing`

## Overview

This module covers **Unit Testing** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Unit Testing
...
Unit Testing is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./104-unit-testing/examples/...
```
