...
> **Category:** system-design | **Level:** advanced | **Module:** `144-caching`

## Overview

This module covers **Caching Strategies** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Caching Strategies
...
Caching Strategies is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
