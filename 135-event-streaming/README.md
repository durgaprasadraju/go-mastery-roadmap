...
> **Category:** messaging | **Level:** advanced | **Module:** `135-event-streaming`

## Overview

This module covers **Event Streaming** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Event Streaming
...
Event Streaming is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./135-event-streaming/examples/...
```
