# Event Streaming — Exercises

**Event Streaming** — pub/sub, streaming, queues.

## Exercise 1: Core Implementation

Implement and understand the core **Event Streaming** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./135-event-streaming/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./135-event-streaming/exercises/solutions/ -run TestService
```
...
```bash
go test ./135-event-streaming/exercises/solutions/ -run TestInterviewChallenge
```
