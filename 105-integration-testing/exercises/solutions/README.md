# Integration Testing — Exercise Solutions
...
|------|----------|-------------|
| `exercise1.go` | Exercise 1 | Core Integration Testing implementation |
...
```bash
go test ./105-integration-testing/exercises/solutions/...
```
