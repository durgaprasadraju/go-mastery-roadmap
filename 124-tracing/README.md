...
> **Category:** observability | **Level:** advanced | **Module:** `124-tracing`

## Overview

This module covers **Distributed Tracing** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Distributed Tracing
...
Distributed Tracing is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
