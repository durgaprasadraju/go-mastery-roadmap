...
> **Category:** testing | **Level:** intermediate | **Module:** `109-benchmarking`

## Overview

This module covers **Benchmarking** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Benchmarking
...
Benchmarking is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./109-benchmarking/examples/...
```
