...
Implement and understand the core **Benchmarking** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./109-benchmarking/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./109-benchmarking/exercises/solutions/ -run TestService
```
...
```bash
go test ./109-benchmarking/exercises/solutions/ -run TestInterviewChallenge
```
