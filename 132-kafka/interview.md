...
### Q1: What is Apache Kafka and why does it matter in Go?

**Answer:** Apache Kafka is a core Go concept used in every production codebase.

**Deep Explanation:** Understanding Apache Kafka demonstrates language fundamentals and informs design decisions in concurrent, distributed systems.

**Follow-up Questions:**
- How would you explain this to a junior developer?
- What Go standard library packages relate to this?

**Production Scenario:** You are building a high-throughput API. How does Apache Kafka affect latency, memory, and correctness?

---

## Intermediate

### Q2: What are common pitfalls with Apache Kafka?
...
**Production Scenario:** A service shows elevated p99 latency. How does Apache Kafka factor into your investigation?

---

## Advanced

### Q3: How would you design a system leveraging Apache Kafka at scale?
...
**Production Scenario:** Design for 10x traffic growth. What changes to your Apache Kafka approach?

---

## Staff Engineer

### Q4: What architectural decisions involve Apache Kafka across a microservices platform?
...
**Production Scenario:** Multi-region deployment with strict SLAs — how does Apache Kafka influence your design?
