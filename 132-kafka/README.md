...
> **Category:** messaging | **Level:** advanced | **Module:** `132-kafka`

## Overview

This module covers **Apache Kafka** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Apache Kafka
...
Apache Kafka is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
