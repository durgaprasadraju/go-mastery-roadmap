...
> **Category:** architecture | **Level:** intermediate | **Module:** `118-repository-pattern`

## Overview

This module covers **Repository Pattern** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Repository Pattern
...
Repository Pattern is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./118-repository-pattern/examples/...
```
