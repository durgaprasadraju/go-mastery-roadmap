...
**Divide & Conquer** — implement, analyze complexity, and benchmark.

## Exercise 1: Core Implementation

Implement and understand the core **Divide & Conquer** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./39-divide-conquer/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./39-divide-conquer/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./39-divide-conquer/exercises/solutions/
```
...
```bash
go test ./39-divide-conquer/exercises/solutions/ -run TestInterviewChallenge
```
