// Package divide_conquer implements Divide & Conquer from scratch for learning purposes.
package divide_conquer

import "errors"

var ErrEmpty = errors.New("divide_conquer: empty structure")
...
// New creates a new Divide & Conquer.
