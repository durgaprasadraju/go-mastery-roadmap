...
> **Category:** networking | **Level:** advanced | **Module:** `82-load-balancing`

## Overview

This module covers **Load Balancing** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Load Balancing
...
Load Balancing is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./82-load-balancing/examples/...
```
