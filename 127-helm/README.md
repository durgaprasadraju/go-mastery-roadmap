...
> **Category:** cloud-native | **Level:** advanced | **Module:** `127-helm`

## Overview

This module covers **Helm** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Helm
...
Helm is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
