...
**Cheat Sheets** — roadmap and reference material.

## Exercise 1: Core Implementation

Implement and understand the core **Cheat Sheets** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./149-cheat-sheets/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./149-cheat-sheets/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./149-cheat-sheets/exercises/solutions/
```
...
```bash
go test ./149-cheat-sheets/exercises/solutions/ -run TestInterviewChallenge
```
