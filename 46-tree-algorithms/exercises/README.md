# Tree Algorithms — Exercises

**Tree Algorithms** — implement, analyze complexity, and benchmark.

## Exercise 1: Core Implementation

Implement and understand the core **Tree Algorithms** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./46-tree-algorithms/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./46-tree-algorithms/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./46-tree-algorithms/exercises/solutions/
```
...
```bash
go test ./46-tree-algorithms/exercises/solutions/ -run TestInterviewChallenge
```
