...
> **Category:** data-structures | **Level:** intermediate | **Module:** `22-binary-search-tree`

## Overview

This module covers **Binary Search Trees** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Binary Search Trees
...
Binary Search Trees is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./22-binary-search-tree/examples/...
```
