...
> **Category:** system-design | **Level:** advanced | **Module:** `142-sharding`

## Overview

This module covers **Sharding** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Sharding
...
Sharding is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
