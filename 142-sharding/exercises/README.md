...
**Sharding** — scalable system components.

## Exercise 1: Core Implementation

Implement and understand the core **Sharding** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./142-sharding/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./142-sharding/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./142-sharding/exercises/solutions/
```
...
```bash
go test ./142-sharding/exercises/solutions/ -run TestInterviewChallenge
```
