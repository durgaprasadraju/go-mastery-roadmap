...
> **Category:** architecture | **Level:** advanced | **Module:** `115-microservices`

## Overview

This module covers **Microservices** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Microservices
...
Microservices is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./115-microservices/examples/...
```
