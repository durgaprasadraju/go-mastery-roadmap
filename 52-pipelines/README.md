...
> **Category:** concurrency | **Level:** intermediate | **Module:** `52-pipelines`

## Overview

This module covers **Pipelines** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Pipelines
...
Pipelines is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
