...
> **Category:** architecture | **Level:** intermediate | **Module:** `116-monoliths`

## Overview

This module covers **Monoliths** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Monoliths
...
Monoliths is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
