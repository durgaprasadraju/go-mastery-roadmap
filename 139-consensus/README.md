...
> **Category:** system-design | **Level:** advanced | **Module:** `139-consensus`

## Overview

This module covers **Consensus Algorithms** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Consensus Algorithms
...
Consensus Algorithms is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
