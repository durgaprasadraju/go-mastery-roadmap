...
> **Category:** cloud-native | **Level:** advanced | **Module:** `130-terraform`

## Overview

This module covers **Terraform** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Terraform
...
Terraform is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
