...
> **Category:** database | **Level:** intermediate | **Module:** `90-connection-pooling`

## Overview

This module covers **Connection Pooling** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Connection Pooling
...
Connection Pooling is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./90-connection-pooling/examples/...
```
