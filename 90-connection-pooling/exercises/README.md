# Connection Pooling — Exercises

**Connection Pooling** — SQL, pooling, transactions.

## Exercise 1: Core Implementation

Implement and understand the core **Connection Pooling** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./90-connection-pooling/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./90-connection-pooling/exercises/solutions/ -run TestService
```
...
```bash
go test ./90-connection-pooling/exercises/solutions/ -run TestInterviewChallenge
```
