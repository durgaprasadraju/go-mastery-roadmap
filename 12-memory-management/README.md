...
> **Category:** fundamentals | **Level:** intermediate | **Module:** `12-memory-management`

## Overview

This module covers **Memory Management** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Memory Management
...
Memory Management is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./12-memory-management/examples/...
```
