...
> **Category:** messaging | **Level:** intermediate | **Module:** `133-rabbitmq`

## Overview

This module covers **RabbitMQ** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind RabbitMQ
...
RabbitMQ is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
