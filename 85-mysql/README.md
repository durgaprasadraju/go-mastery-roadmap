...
> **Category:** database | **Level:** intermediate | **Module:** `85-mysql`

## Overview

This module covers **MySQL** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind MySQL
...
MySQL is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
