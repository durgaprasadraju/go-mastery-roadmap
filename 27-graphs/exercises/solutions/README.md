...
|------|----------|-------------|
| `exercise1.go` | Exercise 1 | Core Graphs implementation |
...
```bash
go test ./27-graphs/exercises/solutions/...
```

## Run Benchmarks

```bash
go test -bench=. ./27-graphs/exercises/solutions/...
```
