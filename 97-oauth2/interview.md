...
### Q1: What is OAuth2 and why does it matter in Go?

**Answer:** OAuth2 is a core Go concept used in every production codebase.

**Deep Explanation:** Understanding OAuth2 demonstrates language fundamentals and informs design decisions in concurrent, distributed systems.

**Follow-up Questions:**
- How would you explain this to a junior developer?
- What Go standard library packages relate to this?

**Production Scenario:** You are building a high-throughput API. How does OAuth2 affect latency, memory, and correctness?

---

## Intermediate

### Q2: What are common pitfalls with OAuth2?
...
**Production Scenario:** A service shows elevated p99 latency. How does OAuth2 factor into your investigation?

---

## Advanced

### Q3: How would you design a system leveraging OAuth2 at scale?
...
**Production Scenario:** Design for 10x traffic growth. What changes to your OAuth2 approach?

---

## Staff Engineer

### Q4: What architectural decisions involve OAuth2 across a microservices platform?
...
**Production Scenario:** Multi-region deployment with strict SLAs — how does OAuth2 influence your design?
