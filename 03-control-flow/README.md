...
> **Category:** fundamentals | **Level:** beginner | **Module:** `03-control-flow`

## Overview

This module covers **Control Flow** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Control Flow
...
Control Flow is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./03-control-flow/examples/...
```
