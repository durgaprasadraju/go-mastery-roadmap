...
> **Category:** observability | **Level:** beginner | **Module:** `119-logging`

## Overview

This module covers **Logging** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Logging
...
Logging is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
