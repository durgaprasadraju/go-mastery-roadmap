...
> **Category:** fundamentals | **Level:** beginner | **Module:** `05-packages-modules`

## Overview

This module covers **Packages & Modules** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Packages & Modules
...
Packages & Modules is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./05-packages-modules/examples/...
```
