...
Implement and understand the core **Race Conditions** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./62-race-conditions/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./62-race-conditions/exercises/solutions/ -run TestService
```
...
```bash
go test ./62-race-conditions/exercises/solutions/ -run TestInterviewChallenge
```
