...
> **Category:** data-structures | **Level:** beginner | **Module:** `17-recursion`

## Overview

This module covers **Recursion** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Recursion
...
Recursion is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
