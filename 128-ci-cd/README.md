...
> **Category:** cloud-native | **Level:** intermediate | **Module:** `128-ci-cd`

## Overview

This module covers **CI/CD** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind CI/CD
...
CI/CD is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
