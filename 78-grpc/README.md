...
> **Category:** networking | **Level:** advanced | **Module:** `78-grpc`

## Overview

This module covers **gRPC** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind gRPC
...
gRPC is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
