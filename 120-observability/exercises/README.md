...
Implement and understand the core **Observability** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./120-observability/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./120-observability/exercises/solutions/ -run TestService
```
...
```bash
go test ./120-observability/exercises/solutions/ -run TestInterviewChallenge
```
