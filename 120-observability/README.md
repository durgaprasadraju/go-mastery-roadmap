...
> **Category:** observability | **Level:** intermediate | **Module:** `120-observability`

## Overview

This module covers **Observability** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Observability
...
Observability is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./120-observability/examples/...
```
