...
> **Category:** architecture | **Level:** advanced | **Module:** `112-ddd`

## Overview

This module covers **Domain-Driven Design** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Domain-Driven Design
...
Domain-Driven Design is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
