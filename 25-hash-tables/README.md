...
> **Category:** data-structures | **Level:** intermediate | **Module:** `25-hash-tables`

## Overview

This module covers **Hash Tables** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Hash Tables
...
Hash Tables is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./25-hash-tables/examples/...
```
