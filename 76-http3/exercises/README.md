...
Implement and understand the core **HTTP/3** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./76-http3/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./76-http3/exercises/solutions/ -run TestService
```
...
```bash
go test ./76-http3/exercises/solutions/ -run TestInterviewChallenge
```
