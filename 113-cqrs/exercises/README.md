...
Implement and understand the core **CQRS** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./113-cqrs/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./113-cqrs/exercises/solutions/ -run TestService
```
...
```bash
go test ./113-cqrs/exercises/solutions/ -run TestInterviewChallenge
```
