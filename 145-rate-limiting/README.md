...
> **Category:** system-design | **Level:** advanced | **Module:** `145-rate-limiting`

## Overview

This module covers **Rate Limiting** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Rate Limiting
...
Rate Limiting is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./145-rate-limiting/examples/...
```
