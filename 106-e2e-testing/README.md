...
> **Category:** testing | **Level:** intermediate | **Module:** `106-e2e-testing`

## Overview

This module covers **E2E Testing** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind E2E Testing
...
E2E Testing is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./106-e2e-testing/examples/...
```
