...
This is a **staff-engineer**-level Go interview question covering **Context**.

## Deep Explanation

Context is a critical concept for Go developers at the staff-engineer level. Refer to the corresponding roadmap module for theory, diagrams, and production code examples.
