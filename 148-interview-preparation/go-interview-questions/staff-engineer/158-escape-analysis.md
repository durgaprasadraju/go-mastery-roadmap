...
This is a **staff-engineer**-level Go interview question covering **Escape Analysis**.

## Deep Explanation

Escape Analysis is a critical concept for Go developers at the staff-engineer level. Refer to the corresponding roadmap module for theory, diagrams, and production code examples.
