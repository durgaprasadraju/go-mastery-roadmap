...
> **Category:** system-design | **Level:** advanced | **Module:** `141-cap-theorem`

## Overview

This module covers **CAP Theorem** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind CAP Theorem
...
CAP Theorem is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./141-cap-theorem/examples/...
```
