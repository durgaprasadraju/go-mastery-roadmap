...
> **Category:** concurrency | **Level:** intermediate | **Module:** `55-select`

## Overview

This module covers **Select Statement** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Select Statement
...
Select Statement is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
