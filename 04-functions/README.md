...
> **Category:** fundamentals | **Level:** beginner | **Module:** `04-functions`

## Overview

This module covers **Functions & Closures** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Functions & Closures
...
Functions & Closures is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
