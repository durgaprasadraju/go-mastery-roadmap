...
> **Category:** observability | **Level:** intermediate | **Module:** `122-grafana`

## Overview

This module covers **Grafana** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Grafana
...
Grafana is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
