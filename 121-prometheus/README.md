...
> **Category:** observability | **Level:** intermediate | **Module:** `121-prometheus`

## Overview

This module covers **Prometheus** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Prometheus
...
Prometheus is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./121-prometheus/examples/...
```
