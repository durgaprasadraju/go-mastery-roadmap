...
> **Category:** fundamentals | **Level:** intermediate | **Module:** `11-error-handling`

## Overview

This module covers **Error Handling** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Error Handling
...
Error Handling is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./11-error-handling/examples/...
```
