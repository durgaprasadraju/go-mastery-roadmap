// Package monotonic_stack implements Monotonic Stack from scratch for learning purposes.
package monotonic_stack

import "errors"

var ErrEmpty = errors.New("monotonic_stack: empty structure")
...
// New creates a new Monotonic Stack.
