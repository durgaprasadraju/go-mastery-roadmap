...
> **Category:** algorithms | **Level:** intermediate | **Module:** `36-monotonic-stack`

## Overview

This module covers **Monotonic Stack** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Monotonic Stack
...
Monotonic Stack is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./36-monotonic-stack/examples/...
```
