...
> **Category:** io | **Level:** intermediate | **Module:** `70-compression`

## Overview

This module covers **Compression** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Compression
...
Compression is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./70-compression/examples/...
```
