...
> **Category:** database | **Level:** intermediate | **Module:** `93-migrations`

## Overview

This module covers **Database Migrations** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Database Migrations
...
Database Migrations is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
