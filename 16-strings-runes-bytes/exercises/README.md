# Strings, Runes & Bytes — Exercises

Implement **Strings, Runes & Bytes** from scratch with tests and complexity analysis.

## Exercise 1: Core Implementation

Implement and understand the core **Strings, Runes & Bytes** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./16-strings-runes-bytes/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./16-strings-runes-bytes/exercises/solutions/ -run TestService
```
...
**Problem:** IsPalindrome ignoring case

Work in interview-challenge.go for 30 minutes before checking solutions/interview-challenge-solution.go.

```bash
go test ./16-strings-runes-bytes/exercises/solutions/ -run TestInterviewChallenge
```
