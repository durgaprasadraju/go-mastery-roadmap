...
> **Category:** security | **Level:** intermediate | **Module:** `99-security`

## Overview

This module covers **Security Fundamentals** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Security Fundamentals
...
Security Fundamentals is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
