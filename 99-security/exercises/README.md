# Security Fundamentals — Exercises

**Security Fundamentals** — auth, crypto, secure coding.

## Exercise 1: Core Implementation

Implement and understand the core **Security Fundamentals** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./99-security/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./99-security/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./99-security/exercises/solutions/
```
...
```bash
go test ./99-security/exercises/solutions/ -run TestInterviewChallenge
```
