...
Implement and understand the core **Learning Roadmap** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./150-roadmap/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./150-roadmap/exercises/solutions/ -run TestService
```
...
```bash
go test ./150-roadmap/exercises/solutions/ -run TestInterviewChallenge
```
