...
> **Category:** observability | **Level:** advanced | **Module:** `123-opentelemetry`

## Overview

This module covers **OpenTelemetry** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind OpenTelemetry
...
OpenTelemetry is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./123-opentelemetry/examples/...
```
