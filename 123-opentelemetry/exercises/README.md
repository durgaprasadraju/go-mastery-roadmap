# OpenTelemetry — Exercises

**OpenTelemetry** — logs, metrics, traces.

## Exercise 1: Core Implementation

Implement and understand the core **OpenTelemetry** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./123-opentelemetry/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./123-opentelemetry/exercises/solutions/ -run TestService
```
...
```bash
go test ./123-opentelemetry/exercises/solutions/ -run TestInterviewChallenge
```
