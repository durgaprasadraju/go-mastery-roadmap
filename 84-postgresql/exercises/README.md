...
Implement and understand the core **PostgreSQL** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./84-postgresql/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./84-postgresql/exercises/solutions/ -run TestService
```
...
```bash
go test ./84-postgresql/exercises/solutions/ -run TestInterviewChallenge
```
