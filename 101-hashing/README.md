...
> **Category:** security | **Level:** intermediate | **Module:** `101-hashing`

## Overview

This module covers **Hashing** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Hashing
...
Hashing is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
