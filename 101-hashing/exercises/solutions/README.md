...
| File | Description |
|------|-------------|
| exercise1.go | Core Hashing exercise |
...
| interview-challenge-solution.go | Implement JWT claims validation |

## Run

```bash
go test ./101-hashing/exercises/solutions/
