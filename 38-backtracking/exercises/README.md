...
**Backtracking** — implement, analyze complexity, and benchmark.

## Exercise 1: Core Implementation

Implement and understand the core **Backtracking** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./38-backtracking/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./38-backtracking/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./38-backtracking/exercises/solutions/
```

## Exercise 4: Interview Challenge

**Problem:** N-Queens count solutions

Work in interview-challenge.go for 30 minutes before checking solutions/interview-challenge-solution.go.

```bash
go test ./38-backtracking/exercises/solutions/ -run TestInterviewChallenge
```
