...
> **Category:** patterns | **Level:** advanced | **Module:** `136-design-patterns`

## Overview

This module covers **Design Patterns** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Design Patterns
...
Design Patterns is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./136-design-patterns/examples/...
```
