...
**Design Patterns** — scalable system components.

## Exercise 1: Core Implementation

Implement and understand the core **Design Patterns** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./136-design-patterns/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./136-design-patterns/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./136-design-patterns/exercises/solutions/
```
...
```bash
go test ./136-design-patterns/exercises/solutions/ -run TestInterviewChallenge
```
