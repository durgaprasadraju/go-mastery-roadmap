...
Implement and understand the core **Graph Algorithms** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./45-graph-algorithms/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./45-graph-algorithms/exercises/solutions/ -run TestService
```
...
```bash
go test ./45-graph-algorithms/exercises/solutions/ -run TestInterviewChallenge
```
