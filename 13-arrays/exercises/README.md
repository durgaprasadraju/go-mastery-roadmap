...
Implement **Arrays** from scratch with tests and complexity analysis.

## Exercise 1: Core Implementation

Implement and understand the core **Arrays** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./13-arrays/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./13-arrays/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./13-arrays/exercises/solutions/
```

## Exercise 4: Interview Challenge

**Problem:** FindDuplicates in fixed array

Work in interview-challenge.go for 30 minutes before checking solutions/interview-challenge-solution.go.

```bash
go test ./13-arrays/exercises/solutions/ -run TestInterviewChallenge
```
