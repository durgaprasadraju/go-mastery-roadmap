...
> **Category:** data-structures | **Level:** intermediate | **Module:** `24-priority-queue`

## Overview

This module covers **Priority Queues** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Priority Queues
...
Priority Queues is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./24-priority-queue/examples/...
```
