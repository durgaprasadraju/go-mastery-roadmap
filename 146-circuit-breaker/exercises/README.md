...
Implement and understand the core **Circuit Breaker** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./146-circuit-breaker/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./146-circuit-breaker/exercises/solutions/ -run TestService
```
...
```bash
go test ./146-circuit-breaker/exercises/solutions/ -run TestInterviewChallenge
```
