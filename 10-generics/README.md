...
> **Category:** fundamentals | **Level:** intermediate | **Module:** `10-generics`

## Overview

This module covers **Generics** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Generics
...
Generics is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
