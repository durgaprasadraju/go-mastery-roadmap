...
Implement and understand the core **Fuzz Testing** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./108-fuzz-testing/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./108-fuzz-testing/exercises/solutions/ -run TestService
```
...
```bash
go test ./108-fuzz-testing/exercises/solutions/ -run TestInterviewChallenge
```
