...
> **Category:** data-structures | **Level:** intermediate | **Module:** `18-linked-lists`

## Overview

This module covers **Linked Lists** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Linked Lists
...
Linked Lists is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
