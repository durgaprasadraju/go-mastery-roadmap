...
> **Category:** algorithms | **Level:** intermediate | **Module:** `32-searching`

## Overview

This module covers **Searching Algorithms** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Searching Algorithms
...
Searching Algorithms is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
