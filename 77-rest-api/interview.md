...
### Q1: What is REST API and why does it matter in Go?

**Answer:** REST API is a core Go concept used in every production codebase.

**Deep Explanation:** Understanding REST API demonstrates language fundamentals and informs design decisions in concurrent, distributed systems.

**Follow-up Questions:**
- How would you explain this to a junior developer?
- What Go standard library packages relate to this?

**Production Scenario:** You are building a high-throughput API. How does REST API affect latency, memory, and correctness?

---

## Intermediate

### Q2: What are common pitfalls with REST API?
...
**Production Scenario:** A service shows elevated p99 latency. How does REST API factor into your investigation?

---

## Advanced

### Q3: How would you design a system leveraging REST API at scale?
...
**Production Scenario:** Design for 10x traffic growth. What changes to your REST API approach?

---

## Staff Engineer

### Q4: What architectural decisions involve REST API across a microservices platform?
...
**Production Scenario:** Multi-region deployment with strict SLAs — how does REST API influence your design?
