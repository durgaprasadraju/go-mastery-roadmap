...
> **Category:** networking | **Level:** intermediate | **Module:** `77-rest-api`

## Overview

This module covers **REST API** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind REST API
...
REST API is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
