...
> **Category:** security | **Level:** advanced | **Module:** `100-encryption`

## Overview

This module covers **Encryption** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Encryption
...
Encryption is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./100-encryption/examples/...
```
