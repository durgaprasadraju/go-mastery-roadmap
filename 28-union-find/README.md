...
> **Category:** data-structures | **Level:** advanced | **Module:** `28-union-find`

## Overview

This module covers **Union-Find** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Union-Find
...
Union-Find is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
