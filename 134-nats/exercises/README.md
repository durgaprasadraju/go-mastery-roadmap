...
Implement and understand the core **NATS** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./134-nats/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./134-nats/exercises/solutions/ -run TestService
```
...
```bash
go test ./134-nats/exercises/solutions/ -run TestInterviewChallenge
```
