...
> **Category:** messaging | **Level:** advanced | **Module:** `134-nats`

## Overview

This module covers **NATS** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind NATS
...
NATS is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
