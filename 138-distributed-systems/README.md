...
> **Category:** system-design | **Level:** advanced | **Module:** `138-distributed-systems`

## Overview

This module covers **Distributed Systems** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Distributed Systems
...
Distributed Systems is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./138-distributed-systems/examples/...
```
