...
**Distributed Systems** — scalable system components.

## Exercise 1: Core Implementation

Implement and understand the core **Distributed Systems** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./138-distributed-systems/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./138-distributed-systems/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./138-distributed-systems/exercises/solutions/
```
...
```bash
go test ./138-distributed-systems/exercises/solutions/ -run TestInterviewChallenge
```
