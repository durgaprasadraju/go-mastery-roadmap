# Distributed Systems — Exercise Solutions
...
|------|----------|-------------|
| `exercise1.go` | Exercise 1 | Core Distributed Systems implementation |
...
```bash
go test ./138-distributed-systems/exercises/solutions/...
```
