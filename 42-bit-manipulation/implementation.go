// Package bit_manipulation implements Bit Manipulation from scratch for learning purposes.
package bit_manipulation

import "errors"

var ErrEmpty = errors.New("bit_manipulation: empty structure")
...
// New creates a new Bit Manipulation.
