...
> **Category:** fundamentals | **Level:** beginner | **Module:** `08-methods`

## Overview

This module covers **Methods** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Methods
...
Methods is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
