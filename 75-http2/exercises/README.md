...
Implement and understand the core **HTTP/2** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./75-http2/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./75-http2/exercises/solutions/ -run TestService
```
...
```bash
go test ./75-http2/exercises/solutions/ -run TestInterviewChallenge
```
