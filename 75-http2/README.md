...
> **Category:** networking | **Level:** advanced | **Module:** `75-http2`

## Overview

This module covers **HTTP/2** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind HTTP/2
...
HTTP/2 is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
