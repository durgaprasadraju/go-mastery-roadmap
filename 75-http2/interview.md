# HTTP/2 — Interview Questions

## Beginner

### Q1: What is HTTP/2 and why does it matter in Go?

**Answer:** HTTP/2 is a core Go concept used in every production codebase.

**Deep Explanation:** Understanding HTTP/2 demonstrates language fundamentals and informs design decisions in concurrent, distributed systems.

**Follow-up Questions:**
- How would you explain this to a junior developer?
- What Go standard library packages relate to this?

**Production Scenario:** You are building a high-throughput API. How does HTTP/2 affect latency, memory, and correctness?

---

## Intermediate

### Q2: What are common pitfalls with HTTP/2?
...
**Production Scenario:** A service shows elevated p99 latency. How does HTTP/2 factor into your investigation?

---

## Advanced

### Q3: How would you design a system leveraging HTTP/2 at scale?
...
**Production Scenario:** Design for 10x traffic growth. What changes to your HTTP/2 approach?

---

## Staff Engineer

### Q4: What architectural decisions involve HTTP/2 across a microservices platform?
...
**Production Scenario:** Multi-region deployment with strict SLAs — how does HTTP/2 influence your design?
