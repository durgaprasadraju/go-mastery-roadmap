...
**Secrets Management** — auth, crypto, secure coding.

## Exercise 1: Core Implementation

Implement and understand the core **Secrets Management** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./102-secrets-management/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./102-secrets-management/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./102-secrets-management/exercises/solutions/
```
...
```bash
go test ./102-secrets-management/exercises/solutions/ -run TestInterviewChallenge
```
