...
> **Category:** testing | **Level:** advanced | **Module:** `110-profiling`

## Overview

This module covers **Profiling** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Profiling
...
Profiling is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
