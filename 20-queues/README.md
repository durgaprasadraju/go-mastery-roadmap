...
> **Category:** data-structures | **Level:** intermediate | **Module:** `20-queues`

## Overview

This module covers **Queues** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Queues
...
Queues is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
