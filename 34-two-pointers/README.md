...
> **Category:** algorithms | **Level:** intermediate | **Module:** `34-two-pointers`

## Overview

This module covers **Two Pointers** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Two Pointers
...
Two Pointers is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./34-two-pointers/examples/...
```
