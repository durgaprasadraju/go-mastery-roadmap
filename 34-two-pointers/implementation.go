// Package two_pointers implements Two Pointers from scratch for learning purposes.
package two_pointers

import "errors"

var ErrEmpty = errors.New("two_pointers: empty structure")
...
// New creates a new Two Pointers.
