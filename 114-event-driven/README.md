...
> **Category:** architecture | **Level:** advanced | **Module:** `114-event-driven`

## Overview

This module covers **Event-Driven Architecture** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Event-Driven Architecture
...
Event-Driven Architecture is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./114-event-driven/examples/...
```
