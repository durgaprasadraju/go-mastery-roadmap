...
> **Category:** algorithms | **Level:** intermediate | **Module:** `33-sliding-window`

## Overview

This module covers **Sliding Window** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Sliding Window
...
Sliding Window is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./33-sliding-window/examples/...
```
