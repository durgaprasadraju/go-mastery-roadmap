...
Implement and understand the core **Sliding Window** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./33-sliding-window/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./33-sliding-window/exercises/solutions/ -run TestService
```
...
```bash
go test ./33-sliding-window/exercises/solutions/ -run TestInterviewChallenge
```
