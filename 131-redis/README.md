...
> **Category:** messaging | **Level:** intermediate | **Module:** `131-redis`

## Overview

This module covers **Redis** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Redis
...
Redis is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
