...
> **Category:** algorithms | **Level:** intermediate | **Module:** `40-greedy`

## Overview

This module covers **Greedy Algorithms** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Greedy Algorithms
...
Greedy Algorithms is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
