...
Implement and understand the core **Greedy Algorithms** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./40-greedy/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./40-greedy/exercises/solutions/ -run TestService
```
