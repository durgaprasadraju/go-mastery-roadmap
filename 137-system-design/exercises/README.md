...
**System Design** — scalable system components.

## Exercise 1: Core Implementation

Implement and understand the core **System Design** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./137-system-design/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./137-system-design/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./137-system-design/exercises/solutions/
```
...
```bash
go test ./137-system-design/exercises/solutions/ -run TestInterviewChallenge
```
