...
> **Category:** concurrency | **Level:** advanced | **Module:** `60-atomic`

## Overview

This module covers **Atomic Operations** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Atomic Operations
...
Atomic Operations is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
