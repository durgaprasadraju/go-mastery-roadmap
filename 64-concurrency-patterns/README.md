...
> **Category:** concurrency | **Level:** advanced | **Module:** `64-concurrency-patterns`

## Overview

This module covers **Concurrency Patterns** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Concurrency Patterns
...
Concurrency Patterns is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./64-concurrency-patterns/examples/...
```
