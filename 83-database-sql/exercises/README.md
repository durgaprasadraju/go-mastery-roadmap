...
**SQL Fundamentals** — SQL, pooling, transactions.

## Exercise 1: Core Implementation

Implement and understand the core **SQL Fundamentals** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./83-database-sql/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./83-database-sql/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./83-database-sql/exercises/solutions/
```
...
```bash
go test ./83-database-sql/exercises/solutions/ -run TestInterviewChallenge
```
