...
> **Category:** database | **Level:** beginner | **Module:** `83-database-sql`

## Overview

This module covers **SQL Fundamentals** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind SQL Fundamentals
...
SQL Fundamentals is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./83-database-sql/examples/...
```
