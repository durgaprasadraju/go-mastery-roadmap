...
> **Category:** cloud-native | **Level:** intermediate | **Module:** `129-github-actions`

## Overview

This module covers **GitHub Actions** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind GitHub Actions
...
GitHub Actions is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./129-github-actions/examples/...
```
