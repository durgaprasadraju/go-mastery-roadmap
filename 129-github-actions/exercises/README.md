...
Implement and understand the core **GitHub Actions** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./129-github-actions/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./129-github-actions/exercises/solutions/ -run TestService
```
...
```bash
go test ./129-github-actions/exercises/solutions/ -run TestInterviewChallenge
```
