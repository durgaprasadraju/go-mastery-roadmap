...
Implement and understand the core **Big-O Analysis** concept in exercise1.go (try yourself first).

**Run tests:**
```bash
go test ./47-big-o-analysis/exercises/solutions/ -run TestExercise1
```
...
```bash
go test ./47-big-o-analysis/exercises/solutions/ -run TestService
```
...
```bash
go test -bench=. ./47-big-o-analysis/exercises/solutions/
```
...
```bash
go test ./47-big-o-analysis/exercises/solutions/ -run TestInterviewChallenge
```
