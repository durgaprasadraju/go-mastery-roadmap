...
> **Category:** complexity | **Level:** beginner | **Module:** `47-big-o-analysis`

## Overview

This module covers **Big-O Analysis** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Big-O Analysis
...
Big-O Analysis is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./47-big-o-analysis/examples/...
```
