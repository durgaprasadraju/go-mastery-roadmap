...
> **Category:** data-structures | **Level:** advanced | **Module:** `29-segment-tree`

## Overview

This module covers **Segment Trees** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Segment Trees
...
Segment Trees is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./29-segment-tree/examples/...
```
