...
> **Category:** security | **Level:** intermediate | **Module:** `95-authorization`

## Overview

This module covers **Authorization** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Authorization
...
Authorization is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./95-authorization/examples/...
```
