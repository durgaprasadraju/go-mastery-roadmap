// Package math_algorithms implements Math Algorithms from scratch for learning purposes.
package math_algorithms

import "errors"

var ErrEmpty = errors.New("math_algorithms: empty structure")
...
// New creates a new Math Algorithms.
