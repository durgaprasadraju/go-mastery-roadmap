...
> **Category:** database | **Level:** intermediate | **Module:** `91-orm-gorm`

## Overview

This module covers **GORM ORM** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind GORM ORM
...
GORM ORM is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
