...
> **Category:** cloud-native | **Level:** advanced | **Module:** `126-kubernetes`

## Overview

This module covers **Kubernetes** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Kubernetes
...
Kubernetes is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./126-kubernetes/examples/...
```
