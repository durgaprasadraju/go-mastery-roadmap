...
> **Category:** networking | **Level:** intermediate | **Module:** `80-server-sent-events`

## Overview

This module covers **Server-Sent Events** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Server-Sent Events
...
Server-Sent Events is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./80-server-sent-events/examples/...
```
