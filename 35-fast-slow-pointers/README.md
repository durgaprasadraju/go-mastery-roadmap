...
> **Category:** algorithms | **Level:** intermediate | **Module:** `35-fast-slow-pointers`

## Overview

This module covers **Fast & Slow Pointers** — a core topic on the Go Mastery Roadmap from beginner to staff engineer level.

## Learning Objectives

- Understand the theory and mental models behind Fast & Slow Pointers
...
Fast & Slow Pointers is fundamental to building reliable Go applications. This module progresses from basic concepts to advanced production patterns used at scale.
...
```bash
go run ./35-fast-slow-pointers/examples/...
```
